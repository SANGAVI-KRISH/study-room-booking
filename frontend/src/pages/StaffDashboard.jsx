  ...
  if (role !== "STAFF" && role !== "ADMIN") {
    return (
      <div style={styles.container}>
        <h2>Access Denied</h2>
        <p>You are not authorized to view the Staff Dashboard.</p>
      </div>
    );
  }
    ...
    <div style={styles.container}>
      ...
      <div style={styles.cardContainer}>
        <div style={styles.card}>
          ...
          <p>Check available rooms and room details.</p>
        ...
        <div style={styles.card}>
          ...
          <p>View and manage student booking requests.</p>
          <button style={styles.disabledButton}>Coming Soon</button>
        </div>

        <div style={styles.card}>
          <h3>Room Availability</h3>
          <p>Monitor room timings and availability status.</p>
          <button style={styles.disabledButton}>Coming Soon</button>
        </div>
      </div>
